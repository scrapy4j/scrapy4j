...
import scrapy4j.xxljob.parser.transformstrategy.DefaultValueTransformStrategy;
import scrapy4j.xxljob.parser.transformstrategy.JSON2StringTransformStrategy;
import scrapy4j.xxljob.parser.transformstrategy.NoneTransformStrategy;
import scrapy4j.xxljob.parser.transformstrategy.SqlTransformStrategy;
...
public class Registry {
    ...
    private final Map<String, Class<? extends scrapy4j.core.itempipeline.ItemPipeline>> itemPipelineMap = new HashMap<>();

    private final Map<String, Class<? extends scrapy4j.core.parser.Parser>> parserMap = new HashMap<>();

    private final Map<String, Class<? extends ItemDefinition>> itemDefinitionMap = new HashMap<>();

    private final Map<String, Class<? extends scrapy4j.xxljob.parser.transformstrategy.TransformStrategy>> transformStrategyMap = new HashMap<>();
    ...
    public void registerItemPipeline(String alias, Class<? extends scrapy4j.core.itempipeline.ItemPipeline> itemPipeline) {
        itemPipelineMap.put(alias, itemPipeline);
    }

    public Class<? extends scrapy4j.core.itempipeline.ItemPipeline> getItemPipeline(String alias) {
        return itemPipelineMap.get(alias);
    }

    public void registerParser(String alias, Class<? extends scrapy4j.core.parser.Parser> parser) {
        parserMap.put(alias, parser);
    }

    public Class<? extends scrapy4j.core.parser.Parser> getParser(String alias) {
    ...
    public void registerTransformStrategy(String alias, Class<? extends scrapy4j.xxljob.parser.transformstrategy.TransformStrategy> transformStrategy) {
        transformStrategyMap.put(alias, transformStrategy);
    }

    public Class<? extends scrapy4j.xxljob.parser.transformstrategy.TransformStrategy> getTransformStrategy(String alias) {
