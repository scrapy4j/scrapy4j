...
import com.victory.scrapy4j.xxljob.support.parser.itemdefinition.ItemDefinition;
...
import com.victory.scrapy4j.xxljob.support.parser.transformstrategy.DefaultValueTransformStrategy;
import com.victory.scrapy4j.xxljob.support.parser.transformstrategy.JSON2StringTransformStrategy;
import com.victory.scrapy4j.xxljob.support.parser.transformstrategy.NoneTransformStrategy;
import com.victory.scrapy4j.xxljob.support.parser.transformstrategy.SqlTransformStrategy;
...
public class Registry {
    ...
    private final Map<String, Class<? extends com.victory.scrapy4j.xxljob.support.parser.transformstrategy.TransformStrategy>> transformStrategyMap = new HashMap<>();
...
//    private final Map<String, Predicate<Response>> parserPredicateMap = new ConcurrentHashMap<>();
    ...
    public void registerItemPipeline(String alias, Class<? extends com.victory.scrapy4j.core.component.itempipeline.ItemPipeline> itemPipeline) {
        itemPipelineMap.put(alias, itemPipeline);
    }

    public Class<? extends com.victory.scrapy4j.core.component.itempipeline.ItemPipeline> getItemPipeline(String alias) {
    ...
    public void registerTransformStrategy(String alias, Class<? extends com.victory.scrapy4j.xxljob.support.parser.transformstrategy.TransformStrategy> transformStrategy) {
        transformStrategyMap.put(alias, transformStrategy);
    }

    public Class<? extends com.victory.scrapy4j.xxljob.support.parser.transformstrategy.TransformStrategy> getTransformStrategy(String alias) {
