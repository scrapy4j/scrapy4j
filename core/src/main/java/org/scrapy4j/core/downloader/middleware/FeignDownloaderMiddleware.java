...
import org.scrapy4j.core.support.feign.*;
...
public class FeignDownloaderMiddleware implements DownloaderMiddleware {
    private org.scrapy4j.core.pojo.Request request;
    private Scheduler scheduler;
    private FeignSettings settings;

    public FeignDownloaderMiddleware(Scheduler scheduler, org.scrapy4j.core.pojo.Request request, FeignSettings settings) {
        this.scheduler = scheduler;
        this.request = request;
        this.settings = settings;
    }

    public FeignDownloaderMiddleware(org.scrapy4j.core.pojo.Request request, FeignSettings settings) {
        this.request = request;
        this.settings = settings;
    }

    @Override
    public org.scrapy4j.core.pojo.Response download() {
        org.scrapy4j.core.pojo.Response response = new org.scrapy4j.core.pojo.Response();
        try {
            ...
            if (this.request.getHttpMethod().equals(feign.Request.HttpMethod.GET)) {
                ...
                org.scrapy4j.core.pojo.Request.RequestBuilder requestBuilder = this.request.toBuilder();
                /**
                 * body resolve
