...
public class FeignDownloaderMiddleware implements DownloaderMiddleware {
    ...
    public FeignDownloaderMiddleware(Scheduler scheduler, Request request, FeignSettings settings) {
        this.scheduler = scheduler;
        this.request = request;
        this.settings = settings;
    }

    public FeignDownloaderMiddleware(Request request, FeignSettings settings) {
        this.request = request;
        this.settings = settings;
    }
    ...
    public Response download() {
        ...
        try {
            ...
            if (this.request.getHttpMethod().equals(feign.Request.HttpMethod.GET)) {
                ...
                Request.RequestBuilder requestBuilder = this.request.toBuilder();
                /**
                 * body resolve
